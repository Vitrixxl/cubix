...
export const Cube3D = memo(function Cube3D({ state, size = 160, mask = "full", rotation, animation, interactive, onRotationChange, className, style }: Cube3DProps) {
  ...
  return (
    <div
      className={className}
      style={{ width: size, height: size, perspective: size * 6, position: "relative", cursor: interactive ? "grab" : undefined, touchAction: "none", contain: interactive ? "layout" : "layout paint", ...style }}
