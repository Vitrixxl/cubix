...
export function PuzzlePreview({puzzle,alg}:{puzzle:PuzzleId;alg:string}){
  ...
  return info.cubeSize?<SetupCube cubeSize={info.cubeSize} alg={alg} size={96} interactive/>:<div className="puzzle-preview"><SpecialPuzzle3D puzzle={puzzle as 'sq1'|'clock'|'pyram'|'skewb'|'minx'} alg={alg}/></div>;
}
