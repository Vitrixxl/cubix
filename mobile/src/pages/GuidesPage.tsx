...
const guides: Record<GuideId, { title: string; lead: string; sections: [string, string][] }> = {
  about: {
    ...
    sections: [
      ...
      ["Accounts and offline practice", "Guest practice is saved on this device. The timer, scrambles, catalogue and guides work offline from installation. An account adds synchronisation between devices, friends and messages. Open Account to switch between Profile, Friends and Messages. Local times are merged when you sign in; synchronisation and messages require a connection."],
  ...
  timer: {
    ...
    sections: [
      ...
      ["3. Stop and review", "Tap the screen to stop. Your time is saved and the next scramble appears. Open Times to inspect scrambles and apply +2 or DNF. Use the buttons on the right of each time to delete it or share it with a friend."],
  ...
  algorithms: {
    ...
    sections: [
      ["Browse by stage", "F2L pairs a corner and an edge to finish the first two layers. OLL orients the last layer. PLL permutes it. Stage tabs jump between sections; set switches choose 2-look or full variants. Other puzzles have their own stages and sets."],
