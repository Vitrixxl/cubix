...
const guides: Record<GuideId, { title: string; lead: string; sections: [string, string][] }> = {
  ...
  timer: {
    ...
    sections: [
      ...
      ["3. Stop and review", "Tap the screen to stop. Your time is saved and the next scramble appears. Open Times to inspect scrambles and apply +2 or DNF. Long press a time to delete it or share it with a friend."],
