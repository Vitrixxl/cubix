...
const guides: Record<GuideId, { title: string; lead: string; sections: [string, string][] }> = {
  ...
  timer: {
    ...
    sections: [
      ["1. Choose a puzzle and scramble", "Open Settings with the gear in the navigation bar to change the active puzzle, theme or accent. On phones, the bottom toolbar contains scramble type, solve mode, time entry, New scramble and Times. New scramble generates another one."],
